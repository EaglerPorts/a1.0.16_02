...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float var1, boolean var2, int var3, int var4) {
		...
		if (this.mc.options.d) {
			...
			var21 = "Used memory: " + var19 * 100L / var22 + "% (" + var19 / 1024L / 1024L + "MB) of " + var22 / 1024L / 1024L
					+ "MB";
			...
			if (this.mc.options.showFramerate) var8.drawStringWithShadow("Minecraft Alpha v1.0.16_02 (" + this.mc.fps + " fps)", 2, 2, 16777215);
			else var8.drawStringWithShadow("Minecraft Alpha v1.0.16_02", 2, 2, 16777215);
			if (this.mc.options.showCoords) var8.drawStringWithShadow("x: " + (int) Math.floor(this.mc.thePlayer.posX) + ", y: " + (int) Math.floor(this.mc.thePlayer.posY) + ", z: " + (int) Math.floor(this.mc.thePlayer.posZ), 2, 12, 16777215);
		}
