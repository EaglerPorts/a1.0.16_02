...
public class GuiMultiplayer extends GuiScreen {
	...
	public void initGui() {
		...
		if (!this.locked) this.serverAddress = this.mc.options.lastServer.replaceAll("_", ":");
		else this.mc.options.lastServer = this.serverAddress.replaceAll(":", "_");
	...
	protected void actionPerformed(GuiButton var1) {
		if(var1.enabled) {
			if(var1.id == 1) {
				...
				this.mc.options.lastServer = this.serverAddress.replaceAll(":", "_");
				this.mc.options.saveOptions();
				this.mc.session.username = this.username;
