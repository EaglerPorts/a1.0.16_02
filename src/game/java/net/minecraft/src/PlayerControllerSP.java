...
public class PlayerControllerSP extends PlayerController {
	...
	private SpawnerAnimals monsterSpawner = new SpawnerMonsters(this, 200, IMobs.class, new EntitySupplier[]{EntityZombie::new, EntitySkeleton::new, EntityCreeper::new, EntitySpider::new, EntitySlime::new});
	private SpawnerAnimals animalSpawner = new SpawnerAnimals(20, EntityAnimal.class, new EntitySupplier[]{EntitySheep::new, EntityPig::new, EntityCow::new, EntityChicken::new});
