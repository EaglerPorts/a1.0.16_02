...
public abstract class Entity {
	...
	public void moveEntity(double var1, double var3, double var5) {
		if (this.noClip) {
			...
			this.distanceWalkedModified = (float) ((double) this.distanceWalkedModified
					+ (double) MathHelper.sqrt_double(var35 * var35 + var22 * var22) * 0.6D);
			int var25;
			int var36;
			int var38;
	...
	public EntityItem entityDropItem(int var1, int var2, float var3) {
		EntityItem var4 = new EntityItem(this.worldObj, this.posX, this.posY + (double) var3, this.posZ,
				new ItemStack(var1, var2));
