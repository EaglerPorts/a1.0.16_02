...
public class GameSettings {
	...
	public KeyBinding[] keyBindings = new KeyBinding[]{this.keyBindForward, this.keyBindLeft, this.keyBindBack, this.keyBindRight, this.keyBindJump, this.keyBindDrop, this.keyBindInventory, this.keyBindChat, this.keyBindZoom, this.keyBindCommand};
	...
	public void loadOptions() {
		try {
			...
			while(true) {
				...
				if(var3[0].equals("lastServer") && !ScuffedUtils.isStringEmpty(var3[1])) {
