...
public class GuiMainMenu extends GuiScreen {
	...
	public GuiMainMenu() {
		try {
			...
			BufferedReader var2 = new BufferedReader(
					new InputStreamReader(EagRuntime.getResourceStream("/title/splashes.txt")));
			String var3 = "";
	...
	public void initGui() {
		...
		this.controlList.add(new GuiButton(3, this.width / 2 - 100, this.height / 4 + 96, "View on Github"));
	...
	private void drawLogo(float var1) {
		...
		for (int var4 = 0; var4 < 3; ++var4) {
			...
			GL11.glTranslatef((float) (-this.logoBlockLayers[0].length()) * 0.5F,
					(float) (-this.logoBlockLayers.length) * 0.5F, 0.0F);
