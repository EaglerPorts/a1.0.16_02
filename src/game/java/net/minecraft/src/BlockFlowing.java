...
public class BlockFlowing extends BlockFluid {
		...
		if (var6 > 0) {
			...
			if (this.numAdjacentSources >= 2 && this.material == Material.water) {
				if (var1.isBlockNormalCube(var2, var3 - 1, var4)) {
					var9 = 0;
				} else if (var1.getBlockMaterial(var2, var3 - 1, var4) == this.material
	...
	private int calculateFlowCost(World var1, int var2, int var3, int var4, int var5, int var6) {
		...
		for (int var8 = 0; var8 < 4; ++var8) {
			if ((var8 != 0 || var6 != 1) && (var8 != 1 || var6 != 0) && (var8 != 2 || var6 != 3)
				...
				if (!this.blockBlocksFlow(var1, var9, var3, var11) && (var1.getBlockMaterial(var9, var3, var11) != this.material
	...
	private boolean[] getOptimalFlowDirections(World var1, int var2, int var3, int var4) {
		...
		for (var5 = 0; var5 < 4; ++var5) {
			...
			if (!this.blockBlocksFlow(var1, var6, var3, var8) && (var1.getBlockMaterial(var6, var3, var8) != this.material
	...
	private boolean blockBlocksFlow(World var1, int var2, int var3, int var4) {
		...
		if (var5 != Block.doorWood.blockID && var5 != Block.doorSteel.blockID && var5 != Block.signStanding.blockID
	...
	private boolean liquidCanDisplaceBlock(World var1, int var2, int var3, int var4) {
		...
		return var5 == this.material ? false
