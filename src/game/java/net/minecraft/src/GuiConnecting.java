...
public class GuiConnecting extends GuiScreen {
	...
	public GuiConnecting(Minecraft var1, String var2) {
		...
		// A1.0.16_02 TODO: (new ThreadConnectToServer(this, var1, var2, var3)).start();
	}
	...
	public void drawScreen(int var1, int var2, float var3) {
		...
		if (this.clientHandler == null) {
			...
			this.drawCenteredString(this.fontRenderer, this.clientHandler.loginProgress, this.width / 2, this.height / 2 - 10,
					16777215);
		}
