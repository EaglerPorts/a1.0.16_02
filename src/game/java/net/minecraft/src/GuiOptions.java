...
public class GuiOptions extends GuiScreen {
	...
	public void initGui() {
		...
		for(int var1 = 0; var1 < this.options.numberOfOptions; ++var1) {
			this.controlList.add(new GuiSmallButton(var1, this.width / 2 - 155 + i % 2 * 160, this.height / 6 + 24 * (i >> 1), this.options.getOptionDisplayString(var1)));
			++i;
		}

		ArrayList<GuiButton> extraOpts = new ArrayList<>();
		// extraOpts.add(new GuiButton(100, this.width / 2 - 100, this.height / 6 + 120 + 12, "Controls..."));

		
		this.controlList.add(new GuiButton(100, this.width / 2 - 100, this.height / 6 + 24 * (++i >> 1), "Controls..."));
